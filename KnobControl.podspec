...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Aly"
  # s.authors            = { "Aly" => "aly.yakan@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Aly"
  ...
  s.source       = { :git => "https://github.com/alyakan/KnobControl.git", :tag => "1.0.0" }
